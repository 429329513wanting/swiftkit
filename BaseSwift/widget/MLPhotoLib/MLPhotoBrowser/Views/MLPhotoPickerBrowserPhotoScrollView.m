...
//            }];
            ...
            [_photoImageView sd_setImageWithURL:photo.originalImageUrl?:photo.thumbImageUrl placeholderImage:nil completed:^(UIImage * _Nullable image, NSError * _Nullable error, SDImageCacheType cacheType, NSURL * _Nullable imageURL) {
